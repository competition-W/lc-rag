...
async def test_mouse_heart_query():
    """测试修复后的查询服务"""
    print("📊 测试修复后的查询服务 - 小鼠心脏数据")
    print("=" * 60)
    
    # 测试查询
    test_query = "查询小鼠心脏的实验数据"
...
if __name__ == "__main__":
    asyncio.run(test_mouse_heart_query())
